...
if (APPLE)
    if (CMAKE_SYSTEM_NAME STREQUAL "iOS")
        string(TOLOWER "${CMAKE_OSX_SYSROOT}" _accesskit_sysroot)
        if (_accesskit_sysroot MATCHES "iphonesimulator")
            set(_accesskit_os "ios-simulator")
        else()
            set(_accesskit_os "ios")
        endif()
        unset(_accesskit_sysroot)
    else()
...
elseif (ANDROID)
    set(_accesskit_os "android")
    set(_accesskit_arch "${ANDROID_ABI}")
elseif (UNIX)

...
/// `CastPtr` represents the relationship between a snake case type (like `tree_update`)
/// and the corresponding Rust type (like `TreeUpdate`). For each matched pair of types, there

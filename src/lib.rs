...
/// `CastPtr` represents the relationship between a snake case type (like `frozen_node`)
/// and the corresponding Rust type (like `FrozenNode`). For each matched pair of types, there
